...
def run():
    ...
    importBalance("MVT_Balance_jan_dec", 0)
...
def importBalance(file_name, type=0):
    ...
    try:
        ...
        if default_storage.exists(file_path):
            ...
            annee_fiscale = Model_Annee_fiscale.objects.get(designation = "Fisc 2022")
            ...
            designation = "Mouvment JAN-DEC 2021"
            ...
            description = ""
            journal_id = None
            date_piece = annee_fiscale.date_fin
            ...
            for i in df.index:
                ...
                libelle = "Mouvement JAN - DEC 2021"
                montant_debit = makeFloat(df['montant_debit'][i])
                montant_credit = makeFloat(df['montant_credit'][i])

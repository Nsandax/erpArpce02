        ...
        try:
            ...
            if default_storage.exists(file_path):
                ...
                for i in df.index:
                    ...
                    if int(df["NETPAYER"][i]) == 0: continue
                    ...
                    if employe:
                        ...
                        if int(periode.month) == 12 and df["SALBASE"][i] == 0:
                            est_regulier = False
                        else: est_regulier = True
                        ...
                        #On Cree le Bulletin
                        bulletin = Model_Bulletin.objects.filter(reference =reference, lot_id = lot.id).first()
                        # print('bulletinCheck', bulletin)
                        # if bulletin != None:continue
                        print('---Iteration', i)
                        ...
                        if est_regulier == True:
                            ...
                            #     # print('-----rubprimecumulirpp lot', lot)
                            #     if lot == None:
                            #         montantirpp = 0

...
@shared_task
def archiver(path, url_document ,nom_document,type_document,reference_document,auteur_id,description = None,dossier_id = None, est_verifie = False, status = None):
    ...
    try:
        ...
        document=dao_document.toSaveDocument(auteur_id, document)

...
class dao_wkf_historique_etat_facturation(object):
    id = 0
    employe_id = None
    etape_id = None
    ...
    @staticmethod
    def toListHistoriqueOfFacture(etat_facturation_id):
        return Model_Wkf_Historique.objects.filter(etat_facturation_id = etat_facturation_id)

    @staticmethod
    def toCreateHistoriqueWorkflow(employe_id , etape_id , etat_facturation_id = None):        
        try:
            historique_workflow = dao_wkf_historique_etat_facturation()
            historique_workflow.employe_id = employe_id
            historique_workflow.etape_id = etape_id
            historique_workflow.etat_facturation_id = etat_facturation_id
    ...
    def toSaveHistoriqueWorkflow(object_dao_wkf_historique):
        try:
            ...
            historique_workflow.etat_facturation_id = object_dao_wkf_historique.etat_facturation_id
    ...
    @staticmethod
    def getCountSignatures(etape_id, etat_facturation_id):
        try:
            historique_workflow = Model_Wkf_Historique.objects.filter(etape_id = etape_id, etat_facturation_id = etat_facturation_id)            
    ...
    @staticmethod
    def toGetIfSigned(etape_id, etat_facturation_id, employe_id):
        try:
            historique_workflow = Model_Wkf_Historique.objects.filter(etape_id = etape_id, etat_facturation_id = etat_facturation_id, employe_id = employe_id) 

...
class dao_wkf_historique_facture(object):
    id = 0
    employe_id = None
    etape_id = None
    facture_id = None
    ...
    @staticmethod
    def toListHistoriqueOfFacture(facture_id):
        return Model_Wkf_Historique.objects.filter(facture_id = facture_id)

    @staticmethod
    def toCreateHistoriqueWorkflow(employe_id , etape_id , facture_id = None):        
        try:
            historique_workflow = dao_wkf_historique_facture()
            historique_workflow.employe_id = employe_id
            historique_workflow.etape_id = etape_id
            historique_workflow.facture_id = facture_id
    ...
    def toSaveHistoriqueWorkflow(object_dao_wkf_historique):
        try:
            ...
            historique_workflow.facture_id = object_dao_wkf_historique.facture_id
    ...
    @staticmethod
    def getCountSignatures(etape_id, facture_id):
        try:
            historique_workflow = Model_Wkf_Historique.objects.filter(etape_id = etape_id, facture_id = facture_id)            
    ...
    @staticmethod
    def toGetIfSigned(etape_id, facture_id, employe_id):
        try:
            historique_workflow = Model_Wkf_Historique.objects.filter(etape_id = etape_id, facture_id = facture_id, employe_id = employe_id) 

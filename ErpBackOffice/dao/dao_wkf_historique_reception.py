...
class dao_wkf_historique_reception(object):
    id = 0
    employe_id = None
    etape_id = None
    ...
    @staticmethod
    def toListHistoriqueOfReception(reception_id):
        return Model_Wkf_Historique.objects.filter(bon_reception_id = reception_id)

    @staticmethod
    def toCreateHistoriqueWorkflow(employe_id , etape_id , bon_reception_id = None):        
        try:
            historique_workflow = dao_wkf_historique_reception()
            historique_workflow.employe_id = employe_id
            historique_workflow.etape_id = etape_id
            historique_workflow.bon_reception_id = bon_reception_id
    ...
    def toSaveHistoriqueWorkflow(object_dao_wkf_historique):
        try:
            ...
            historique_workflow.bon_reception_id = object_dao_wkf_historique.bon_reception_id
    ...
    @staticmethod
    def getCountSignatures(etape_id, bon_reception_id):
        try:
            historique_workflow = Model_Wkf_Historique.objects.filter(etape_id = etape_id, bon_reception_id = bon_reception_id)            
    ...
    @staticmethod
    def toGetIfSigned(etape_id, bon_reception_id, employe_id):
        try:
            historique_workflow = Model_Wkf_Historique.objects.filter(etape_id = etape_id, bon_reception_id = bon_reception_id, employe_id = employe_id) 

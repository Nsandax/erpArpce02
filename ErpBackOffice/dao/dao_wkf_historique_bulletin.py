...
class dao_wkf_historique_bulletin(object):
    id = 0
    employe_id = None
    etape_id = None
    bulletin_id = None
    ...
    @staticmethod
    def toListHistoriqueOfBulletin(bulletin_id):
        return Model_Wkf_Historique.objects.filter(bulletin_id = bulletin_id)

    @staticmethod
    def toCreateHistoriqueWorkflow(employe_id , etape_id , bulletin_id = None):        
        try:
            historique_workflow = dao_wkf_historique_bulletin()
            historique_workflow.employe_id = employe_id
            historique_workflow.etape_id = etape_id
            historique_workflow.bulletin_id = bulletin_id
    ...
    def toSaveHistoriqueWorkflow(object_dao_wkf_historique):
        try:
            ...
            historique_workflow.bulletin_id = object_dao_wkf_historique.bulletin_id
    ...
    @staticmethod
    def getCountSignatures(etape_id, bulletin_id):
        try:
            historique_workflow = Model_Wkf_Historique.objects.filter(etape_id = etape_id, bulletin_id = bulletin_id)            
    ...
    @staticmethod
    def toGetIfSigned(etape_id, bulletin_id, employe_id):
        try:
            historique_workflow = Model_Wkf_Historique.objects.filter(etape_id = etape_id, bulletin_id = bulletin_id, employe_id = employe_id) 

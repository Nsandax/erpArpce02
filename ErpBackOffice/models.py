...
class Model_Bon_reception(models.Model):
    ...
    contrat                  =    models.ForeignKey("Model_Contrat", on_delete=models.SET_NULL, related_name="bon_reception_contrat", blank=True, null=True)
    ...
    url                      =    models.CharField(max_length = 250, blank=True, null=True)
    po_header_id             =    models.CharField(max_length = 250, blank=True, null=True)
    segment1                 =    models.CharField(max_length = 250, blank=True, null=True)
...
class Model_Ligne_reception(models.Model):
    ...
    creation_date            =    models.DateTimeField(auto_now_add=True)
    url                      =    models.CharField(max_length = 250, blank=True, null=True)
    polineID                 =    models.CharField(max_length = 250, blank=True, null=True)
...
class Model_Asset(models.Model):
    ...
    description = models.CharField(max_length = 250, null = True, blank=True, default = '')
    asset_number = models.CharField(max_length = 250, null = True, blank=True, default = '')
    attribute_categorie_code = models.CharField(max_length = 250, null = True, blank=True, default = '')
    serial_number = models.CharField(max_length = 250, null = True, blank=True, default = '')
    asset_type = models.CharField(max_length = 250, null = True, blank=True, default = '')
...
class Model_Employe(Model_Personne):
    ...
    cycle_diplome            =    models.CharField(max_length = 100 ,null = True , blank = True)
...
# MODULE VENTE
class Model_TypeClient(models.Model):
    designation =   models.CharField(max_length = 100, null = True, blank=True, default = '')
...
class Model_Client(Model_Personne):
    ...
    typeclient              =   models.ForeignKey("Model_TypeClient", on_delete = models.SET_NULL, related_name="client_type", blank=True, null=True)
...
class Model_GroupementCombinaisonB(models.Model):
    code            =    models.CharField(max_length=50, null = True, blank = True)
    designation     =    models.CharField(max_length=50, null = True, blank = True)
    creation_date   =    models.DateTimeField(auto_now_add = True)
    update_date     =    models.DateTimeField(auto_now_add = True)
    categoriebudget =    models.ForeignKey("Model_Categoriebudget", on_delete=models.CASCADE, blank=True, null=True)
    lignebudgetaire =    models.ManyToManyField("Model_LigneBudgetaire", related_name="lignebudgetaire_related_to_a_group", blank = True)
    statut          =    models.ForeignKey("Model_Wkf_Etape", on_delete=models.SET_NULL, blank=True, null=True)
    etat            =    models.CharField(max_length=50, blank=True, null=True)
    auteur          =    models.ForeignKey(Model_Personne, on_delete = models.SET_NULL, related_name = 'auteur_regourpe_budgets', null = True, blank = True)
    ...
    def montant_engage(self):
        montant = 0
        try:
            for item in self.lignebudgetaire.all():
                # budget = Model_Budget.objects.filter(pk = item.budget.id)
                montant = montant + float(item.valeur_engagement)
                devise = item.devise
            return montant
        except Exception as e:
            # print(e)
    ...
    def montant_disponible(self):
        ...
        try:
            for item in self.lignebudgetaire.all():
                # print('iteration {}: {}'.format(item, item.valeur_solde))
                montant = montant + float(item.valeur_solde)
    ...
    def devise(self):
        ...
        try:
            for item in self.lignebudgetaire.all():
                devise = item.budget.devise.symbole_devise
            return devise
        except Exception as e:
            return devise
...
class Model_Budget(models.Model):
    ...
    def solde(self):
        ...
        try:
            solde = 0
            exercice = Model_Exercicebudgetaire.objects.filter(is_active = True).first()
            if exercice:
                lignes = Model_LigneBudgetaire.objects.filter(budget = self, exericebudgetaires__id = exercice.id)
...
class Model_LigneBudgetaire(models.Model):
    ...
    lastyearrepart          =   models.CharField(max_length = 10, blank=True, null=True, default="")
    ...
    update_date             =   models.DateTimeField(auto_now=True)
    creation_date           =   models.DateTimeField(auto_now_add = True)
    exericebudgetaires     =    models.ForeignKey("Model_Exercicebudgetaire", on_delete=models.CASCADE, blank=True, null=True)
...
class Model_Nature(models.Model):
    code = models.CharField(max_length = 2, null = True, blank=True, default = '')
    designation = models.CharField(max_length = 150, null = True, blank=True, default = '')
    statut = models.ForeignKey(Model_Wkf_Etape, on_delete = models.SET_NULL, related_name = 'statut_fgtk_hgk_nature', null = True, blank = True)
    etat = models.CharField(max_length = 100, null = True, blank=True, default = ' ')
    created_at = models.DateTimeField(null=True, blank=True)
    update_at = models.DateTimeField(auto_now = True)
    auteur = models.ForeignKey(Model_Personne, on_delete = models.SET_NULL, related_name = 'auteur_de_model_nature_hgp', null = True, blank = True)
...
class Model_regorupement_budgetaire(models.Model):
    ...
    detail_compte   =    models.CharField(max_length = 300, null = True, blank = True)

...
class dao_avis_appel_offre(object):
	...
	@staticmethod
	def toListAppelOffreByTypeMarche(type_marche_id):
		return Model_Avis_appel_offre.objects.filter(type_marche_id = type_marche_id).order_by('-id')
	...
	@staticmethod
	def toCreateAvis_appel_offre(numero_reference,numero_dossier,designation_commission,objet_appel,financement,type_appel_offre,lieu_consultation,qualification,conditions,date_signature,lieu_depot,date_depot,delai_engagement,montant_commission,desc, demande_achat_id = None, type_marche_id = None, nombre_lots = 0, montant = None, devise_id = None):
		try:
			...
			avis_appel_offre.objet_appel = objet_appel
			...
			avis_appel_offre.montant = montant
			avis_appel_offre.devise_id = devise_id
	...
	def toSaveAvis_appel_offre(auteur, objet_dao_Avis_appel_offre):
		try:
			...
			avis_appel_offre.objet_appel = objet_dao_Avis_appel_offre.objet_appel
			...
			avis_appel_offre.montant = objet_dao_Avis_appel_offre.montant
			avis_appel_offre.devise_id = objet_dao_Avis_appel_offre.devise_id
